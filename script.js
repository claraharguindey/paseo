const locations = [
  ...
  { text: "Llegas al patio de colegio" },
  { text: "Caminas por el sitio donde se abrió aquella ventana" },
  { text: "Aquí hay muchos charcos" },
  ...
  { text: "Esquivas los charcos con arcoiris de gasolina" },
  { text: "Pasas por donde creció el durazno" },
  { text: "Atraviesas el pasillo" },
  { text: "Caminas por donde tiró de sí misma" },
  { text: "Llegas al punto donde es demasiado tarde" },
  { text: "Pasas por el último lugar que quedaba" },
  { text: "Atraviesas el sitio donde no había otra manera" },
  { text: "En este lugar ya habías estado antes" },
  ...
  { text: "Caminas con otra intención" },
  ...
  { text: "Llegas con la intención de recordar algo" },
];
